...
export type { UsageInfo, StreamResult, GatewayCallbacks } from "./providers/common"
export { ApiError } from "./providers/common"
...
export async function streamChat(
  ...
  if (provider === "local") {
    const url = getBaseUrl(provider, model, false, null)
    return streamLocal(messages, model, callbacks, headers, url, signal)
  }
